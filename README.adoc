...
| Exigences utilisateurs | link:architecture/Boutique%20en%20ligne%20-%20Exigences%20utilisateurs.adoc[AsciiDoc] / link:architecture/Boutique%20en%20ligne%20-%20Exigences%20utilisateurs.html[HTML] | Besoins opérationnels et exigences de sécurité (ANSSI)
| Documentation d'architecture | link:architecture/main.adoc[AsciiDoc] / link:architecture/Boutique%20en%20ligne%20-%20Documentation%20d%27Architecture.html[HTML] / link:architecture/Boutique%20en%20ligne%20-%20Documentation%20d%27Architecture.pdf[PDF] | Les quatre niveaux ARCADIA (OA → SA → LA → PA)
| Backlog | link:architecture/05-backlog/us.adoc[AsciiDoc] | User Stories et critères d'acceptation
|===

Le projet a pour objectif de développer une application web de boutique en ligne. Il débutera par la rédaction d'un document d'architecture, les différents livrables étant produits avec l'assistance d'une IA.
...
Le document d'architecture est produit à partir du link:architecture/Boutique%20en%20ligne%20-%20Exigences%20utilisateurs.adoc[*document des exigences utilisateurs*], qui constitue l'entrant formel de la démarche ARCADIA. Ce document recense les besoins opérationnels des acteurs (administrateur, vendeur, acheteur) ainsi que les exigences de sécurité issues des recommandations ANSSI, et sert de référence tout au long des quatre niveaux d'analyse.

NOTE: La solution respecte les **recommandations de sécurité de l'https://www.ssi.gouv.fr/[ANSSI]** (Agence nationale de la sécurité des systèmes d'information). Ces recommandations sont déclinées sur les quatre niveaux ARCADIA de l'architecture — OA, SA, LA, PA — et implémentées dans le code : TLS 1.3, hachage BCrypt, protection contre la force brute, en-têtes HTTP de sécurité (CSP, HSTS, X-Frame-Options) et journalisation d'audit. Références : https://www.ssi.gouv.fr/guide/recommandations-relatives-a-lauthentification-multifacteur-et-aux-mots-de-passe/[ANSSI-BP-076] (authentification et mots de passe), https://www.ssi.gouv.fr/guide/recommandations-de-securite-relatives-a-tls/[ANSSI-BP-113] (TLS), https://www.ssi.gouv.fr/guide/recommandations-pour-la-securisation-des-sites-web/[guide de sécurisation des sites web], https://cyber.gouv.fr/guide-si-sensibles-cloud[guide SI sensibles — cloud].
...
Les cas d'utilisation seront implémentés de manière itérative, l'un après l'autre, en suivant un cycle de développement structuré et reproductible.
...
| User requirements | link:architecture/Boutique%20en%20ligne%20-%20Exigences%20utilisateurs.adoc[AsciiDoc] / link:architecture/Boutique%20en%20ligne%20-%20Exigences%20utilisateurs.html[HTML] | Operational needs and ANSSI security requirements
| Architecture document | link:architecture/main.adoc[AsciiDoc] / link:architecture/Boutique%20en%20ligne%20-%20Documentation%20d%27Architecture.html[HTML] / link:architecture/Boutique%20en%20ligne%20-%20Documentation%20d%27Architecture.pdf[PDF] | All four ARCADIA levels (OA → SA → LA → PA)
| Backlog | link:architecture/05-backlog/us.adoc[AsciiDoc] | User Stories and acceptance criteria
|===

The project aims to develop an online shop web application. It will begin with the writing of an architecture document, with the various deliverables produced with the assistance of an AI.
...
The architecture document is produced from the link:architecture/Boutique%20en%20ligne%20-%20Exigences%20utilisateurs.adoc[*user requirements document*], which constitutes the formal input to the ARCADIA process. This document captures the operational needs of all actors (administrator, vendor, buyer) as well as the security requirements derived from ANSSI recommendations, and serves as the reference throughout all four levels of analysis.

NOTE: The solution complies with **https://www.ssi.gouv.fr/en/[ANSSI] security recommendations** (French national cybersecurity agency). These recommendations are traced across all four ARCADIA levels — OA, SA, LA, PA — and implemented in the code: TLS 1.3, BCrypt hashing, brute-force protection, HTTP security headers (CSP, HSTS, X-Frame-Options), and audit logging. References: https://www.ssi.gouv.fr/guide/recommandations-relatives-a-lauthentification-multifacteur-et-aux-mots-de-passe/[ANSSI-BP-076] (authentication & passwords), https://www.ssi.gouv.fr/guide/recommandations-de-securite-relatives-a-tls/[ANSSI-BP-113] (TLS), https://www.ssi.gouv.fr/guide/recommandations-pour-la-securisation-des-sites-web/[web application security guide], https://cyber.gouv.fr/guide-si-sensibles-cloud[sensitive IS — cloud guide].
...
Use cases will be implemented one by one in an iterative manner, following a structured and repeatable development cycle.
