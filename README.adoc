...
image::architecture/diagrams/readme/oa-use-case.svg[OA Use Case, 600]
...
image::architecture/diagrams/readme/sa-context.svg[SA Context, 600]
...
image::architecture/diagrams/readme/la-components.svg[LA Components, 600]
...
image::architecture/diagrams/readme/pa-deployment.svg[PA Deployment, 600]
