...
Le document d'architecture est produit à partir du *document des exigences utilisateurs* (_Boutique en ligne - Exigences utilisateurs_), qui constitue l'entrant formel de la démarche ARCADIA. Ce document recense les besoins opérationnels des acteurs (administrateur, vendeur, acheteur) ainsi que les exigences de sécurité issues des recommandations ANSSI, et sert de référence tout au long des quatre niveaux d'analyse.
