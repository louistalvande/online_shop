...
Une fois la solution documentée en détails, l'infrastructure de l'application sera généré puis déployée pour être testée. 

=== III. Développment des cas d'utilisation de manière itérative

Les cas d'utilisation seront développés jusqu'aux tests end2end les uns après les autres. 
