...
La réalisation du projet s'articulera autour de plusieurs grandes étapes, abordées de façon itérative. L'ensemble de ces étapes sera appliqué intégralement pour chaque User Story.
...
=== II. Génération l'infrastructure de la solution [[ii-génération-de-la-solution]]
...
=== III. Développment des cas d'utilisation de manière itérative
...
=== IV. Génération de la documentation utilisateur [[iiii-génération-de-la-documentation-utilisateur]]
...
=== IV. Generating the User Documentation [[iv-generating-the-user-documentation]]
