...
class SalesReportServiceImplTest {
    ...
    @BeforeEach
    void setUp() {
        service = new SalesReportServiceImpl(salesReportRepository);
    }
    ...
    void getSalesReport_nominal_returnsReport() {
        ...
        given(salesReportRepository.computeMetrics(any(LocalDateTime.class),
    ...
    void getSalesReport_noOrders_returnsZeroMetrics() {
        given(salesReportRepository.computeMetrics(any(), any(), isNull()))
    ...
    void exportSalesCsv_withCategory_includesCategoryLine() {
        ...
        given(salesReportRepository.computeMetrics(any(), any(), eq("JEWELRY")))
                .willReturn(metrics);
